...
deepspeed --include localhost:0 --master_port 29501 tinyllava/train/custom_finetune_moelora.py \
    ...
    --pretrained_model_path /root/autodl-tmp/output/checkpoint-3400 \
    --output_dir /root/autodl-tmp/output/tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-finetune-down-moelora1 \
    --lora_r $LORA_R \
    ...
    --run_name tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-finetune_down_moelora